      ...
      const output = `
          <div class="card mb-5">
            <div class="card-body">
              ...
              <p class="bg-danger text-light p-2">
                CODE: ${issue.code}
              </p>
              <a class="text-dark" target="_blank" href="https://www.w3.org/WAI/standards-guidelines/wcag/">Learn more about WCAG2AA standards</a>
            </div>
          </div>
        `;
